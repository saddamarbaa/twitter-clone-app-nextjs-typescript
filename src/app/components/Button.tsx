...
export default function Button({
  ...
  const colors: Colors = {
    ...
    twitterBlue: 'bg-twitterBlue-500 hover:bg-twitterBlue-700 active:bg-twitterBlue-800',
  };
  ...
  return (
    <button
      ...
      className={`${
        preStyled
          ? preStyled
          : 'flex w-full items-center justify-center rounded-full shadow transition duration-100 hover:shadow-lg'
    ...
    >
      ...
      {isLoading ? (
        <div>
          <Image src='/images/svg/Spinner-1s-200px.svg' alt='Loading' width={30} height={30} />
        </div>
      ) : (
        children
      )}
