      ...
      >
        <div className='flex min-h-[500px] w-full max-w-lg flex-col  space-y-5 rounded-lg bg-white p-6 text-black shadow-lg dark:bg-twitterBlack dark:text-twitterWhite dark:shadow-2xl'>
          ...
          <div className='mx-auto flex  w-full max-w-ss flex-col space-y-5 '>
            ...
            <Button
              color='black'
              buttonClassName='text-white font-bold hidden'
            ...
            <div className='text-[13px]'>
              <p>
                ...
                <span className='w-fit  cursor-pointer  px-1 text-twitterBlue-500 hover:underline'>
                  Terms of Service
                </span>
              </p>
              <p>
            ...
            <div className='mt-2 text-center'>
              ...
              <Link
                href='/sign-up'
                className='text-sm text-twitterBlue-500  hover:text-twitterBlue-700 hover:underline'
              >
                Sign up
              </Link>
            </div>
